...
export const DIET_PAGES: MealPlanPageData[] = [
  {
    slug: "vegetarian",
    type: "diet",
    title: "7-Day Vegetarian Meal Plan with Grocery List (Personalized)",
    metaDescription:
      "Personalized 7-day vegetarian meal plan with high-protein recipes and one grocery list. Free preview, no credit card needed.",
  ...
  },
  {
    slug: "vegan",
    type: "diet",
    title: "7-Day Vegan Meal Plan with Grocery List & Recipes",
    metaDescription:
      "Personalized weekly vegan meal plan covering B12, iron, and protein — recipes plus a grocery list. Free preview, no credit card required.",
  ...
  },
  {
    ...
    metaDescription:
      "Personalized gluten-free meal plan with recipes and grocery list. Built for celiac and gluten sensitivity. AI-generated weekly meals. Free preview, no card needed.",
  ...
  },
  {
    slug: "keto",
    type: "diet",
    title: "7-Day Keto Meal Plan with Grocery List (Under 30g Net Carbs)",
    metaDescription:
      "Personalized keto meal plan with recipes and a grocery list. Under 30g net carbs, macro-calculated weekly menus. Free preview, no credit card.",
  ...
  },
  {
    slug: "low-carb",
    type: "diet",
    title: "Low-Carb Meal Plan with Grocery List — Flexible, Not Keto",
    metaDescription:
      "Personalized low-carb meal plan with recipes and grocery list. Flexible carb targets, not keto-strict. Free preview, no card needed.",
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        question: "Is there an app that makes halal meal plans?",
        answer:
          "Yes — What's For Dinner generates a personalized weekly halal meal plan with recipes and a grocery list. Select halal in your dietary preferences and every meal, snack, and grocery item is filtered for compliance automatically, including hidden ingredients like gelatin and alcohol-based extracts. You can see a free preview of your plan before subscribing.",
      },
      {
        question: "What does a week of halal meals look like?",
        answer:
          "A typical week mixes cuisines where halal is the default: shakshuka or labneh toast for breakfasts, chicken shawarma bowls and lentil soups for lunches, and dinners like lamb kofta with couscous, chicken biryani, Moroccan chickpea tagine, and grilled fish with herbed rice. One grocery trip covers the whole week, with halal-certified meat clearly flagged on the list.",
      },
      {
        question: "Are halal meal plans healthy?",
        answer:
          "They can be extremely healthy. Halal cooking traditions lean on legumes, whole grains, olive oil, fresh vegetables, and grilled or braised meats rather than processed foods. Our halal plans balance protein, fiber, and healthy fats across the week — and you can layer on goals like weight loss or high-protein without breaking compliance.",
      },
    ],
