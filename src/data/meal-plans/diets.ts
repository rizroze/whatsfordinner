...
export const DIET_PAGES: MealPlanPageData[] = [
  {
    slug: "vegetarian",
    type: "diet",
    title: "Vegetarian Meal Plan with Grocery List – Free AI Planner",
    metaDescription:
      "Get a free personalized vegetarian meal plan with recipes and grocery list. High-protein, balanced meatless meals generated by AI. No credit card needed.",
  ...
  },
  {
    slug: "vegan",
    type: "diet",
    title: "Vegan Meal Plan with Grocery List – Free & Personalized",
    metaDescription:
      "Free personalized vegan meal plan with recipes and grocery list. AI-generated weekly meals covering B12, iron, and protein. No credit card required.",
  ...
  },
  {
    slug: "keto",
    type: "diet",
    title: "Keto Meal Plan with Grocery List – Free 7-Day Plan",
    metaDescription:
      "Free keto meal plan with recipes and grocery list. Under 30g net carbs, macro-calculated, AI-personalized weekly menus. No credit card required.",
  ...
  },
  {
    slug: "low-carb",
    type: "diet",
    title: "Low-Carb Meal Plan with Grocery List – Free AI Planner",
    metaDescription:
      "Free personalized low-carb meal plan with recipes and grocery list. Flexible carb targets, not keto-strict. AI-generated weekly menus. No card needed.",
